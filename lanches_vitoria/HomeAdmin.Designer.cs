...
namespace lanches_vitoria
{
    partial class HomeAdmin
    {
        ...
        private void InitializeComponent()
        {
            ...
            // button7
            // 
            button7.BackColor = Color.FromArgb(100, 181, 246);
            button7.FlatAppearance.BorderSize = 0;
            button7.FlatStyle = FlatStyle.Flat;
            button7.Font = new Font("Arial Rounded MT Bold", 14.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            button7.ForeColor = Color.White;
            button7.Location = new Point(9, 187);
            button7.Name = "button7";
            button7.Size = new Size(205, 37);
            button7.TabIndex = 7;
            button7.Text = "Gerenciar Usuarios";
            button7.TextAlign = ContentAlignment.MiddleLeft;
            button7.UseVisualStyleBackColor = false;
            // 
            // button6
            // 
            button6.BackColor = Color.FromArgb(100, 181, 246);
            button6.FlatAppearance.BorderSize = 0;
            button6.FlatStyle = FlatStyle.Flat;
            button6.Font = new Font("Arial Rounded MT Bold", 14.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            button6.ForeColor = Color.White;
            button6.Location = new Point(9, 144);
            button6.Name = "button6";
            button6.Size = new Size(205, 37);
            button6.TabIndex = 6;
            button6.Text = "Gerenciar Pedidos";
            button6.TextAlign = ContentAlignment.MiddleLeft;
            button6.UseVisualStyleBackColor = false;
            // 
            // button5
            // 
            button5.BackColor = Color.FromArgb(100, 181, 246);
            button5.FlatAppearance.BorderSize = 0;
            button5.FlatStyle = FlatStyle.Flat;
            button5.Font = new Font("Arial Rounded MT Bold", 14.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            button5.ForeColor = Color.White;
            button5.Location = new Point(9, 101);
            button5.Name = "button5";
            button5.Size = new Size(205, 37);
            button5.TabIndex = 5;
            button5.Text = "Gerenciar Produtos";
